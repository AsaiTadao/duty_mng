                            ...
                            <table class="table table-bordered table-striped table-hover">
                                <thead class="text-center">
                                    <tr class="heavy-green">
                                        <th width="3%" rowspan="2" class="align-middle">社員No</th>
                                        <th rowspan="2" class="align-middle">氏名</th>
                                        <th rowspan="2" class="align-middle">勤務日数</th>
                                        <th rowspan="2" class="align-middle">勤務時間</th>
                                        <th rowspan="2" class="align-middle">遅刻時間</th>
                                        <th rowspan="2" class="align-middle">早退時間</th>
                                        <th rowspan="2" class="align-middle">休憩時間</th>
                                        <th rowspan="2" class="align-middle">実働時間</th>
                                        <th rowspan="2" class="align-middle">残業時間</th>
                                        <th rowspan="2" class="align-middle">連勤日数</th>
