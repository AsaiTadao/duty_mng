                        ...
                        <div class="form-group">
                            <div class="form-row align-items-center">
                                ...
                                <!-- <div class="d-flex align-items-center ml-5 mr-2">
                                    <input type="radio" name="shukkin-minutes" value="1"/>
                                    <div class="mx-1">切り捨て</div>
                                </div> -->
                                <div class="d-flex align-items-center ml-5 mr-2">
                                    <input type="radio" name="shukkin-minutes" value="1" checked/>
                            ...
                            <div class="form-row align-items-center">
                                ...
                                <div class="d-flex align-items-center ml-5 mr-2">
                                    <input type="radio" name="taikin-minutes" value="1" checked/>
                                    <div class="mx-1">切り捨て</div>
                                </div>
                            ...
                            <div class="form-row align-items-center">
                                ...
                                <div class="d-flex align-items-center ml-5 mr-2">
                                    <input type="radio" name="chikoku-minutes" value="1" checked/>
                                    <div class="mx-1">切り上げ</div>
                                </div>
                            </div>
                            <br>
                            <div class="form-row align-items-center">
                                ...
                                <div class="d-flex align-items-center ml-5 mr-2">
                                    <input type="radio" name="sotai-minutes" value="1" checked/>
                                    <div class="mx-1">切り捨て</div>
                                </div>
                                <!-- <div class="d-flex align-items-center ml-2">
                                    <input type="radio" name="taikin-minutes" value="2"/>
