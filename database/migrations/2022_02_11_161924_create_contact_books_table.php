...
class CreateContactBooksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('contact_books', function (Blueprint $table) {
            ...
            $table->time('meal_memo_1_school')->nullable();
            $table->time('meal_memo_2_school')->nullable();
            $table->time('meal_memo_3_school')->nullable();
            ...
            $table->tinyInteger('sleep_start_1_home')->nullable();
            $table->tinyInteger('sleep_end_1_home')->nullable();
            $table->tinyInteger('sleep_start_2_home')->nullable();
            $table->tinyInteger('sleep_end_2_home')->nullable();
            $table->tinyInteger('sleep_start_1_school')->nullable();
            $table->tinyInteger('sleep_end_1_school')->nullable();
            $table->tinyInteger('sleep_start_2_school')->nullable();
            $table->tinyInteger('sleep_end_2_school')->nullable();
            $table->boolean('bathing_home')->nullable();
            $table->boolean('bathing_school')->nullable();
            $table->time('temperature_time_1_home')->nullable();
            $table->float('temperature_1_home', 3, 1);
            $table->time('temperature_time_2_home')->nullable();
            $table->float('temperature_2_home', 3, 1);
            $table->time('temperature_time_3_home')->nullable();
            $table->float('temperature_3_home', 3, 1);
            $table->time('temperature_time_1_school')->nullable();
            $table->float('temperature_1_school', 3, 1);
            $table->time('temperature_time_2_school')->nullable();
            $table->float('temperature_2_school', 3, 1);
            $table->time('temperature_time_3_school')->nullable();
            $table->float('temperature_3_school', 3, 1);
