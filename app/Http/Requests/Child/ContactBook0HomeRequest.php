...
class ContactBook0HomeRequest extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            'defecation_3_home'   =>  ['nullable', 'in:1,2,3'],
            'defecation_4_home'   =>  ['nullable', 'in:1,2,3'],
            'defecation_5_home'   =>  ['nullable', 'in:1,2,3'],
            'defecation_6_home'   =>  ['nullable', 'in:1,2,3'],
            'defecation_7_home'   =>  ['nullable', 'in:1,2,3'],
            'defecation_8_home'   =>  ['nullable', 'in:1,2,3'],
            'defecation_9_home'   =>  ['nullable', 'in:1,2,3'],
            'defecation_10_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_11_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_12_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_13_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_14_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_15_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_16_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_17_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_18_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_19_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_20_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_21_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_22_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_23_home'  =>  ['nullable', 'in:1,2,3'],
            'defecation_24_home'  =>  ['nullable', 'in:1,2,3'],
